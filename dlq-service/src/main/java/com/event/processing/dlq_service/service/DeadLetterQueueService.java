...
public class DeadLetterQueueService implements DeadLetterQueueEventProcessor {
  ...
  public void handleDeadLetterEvents(List<DeadLetterQueueEventDTO> events) {
    ...
    List<DeadLetterEvent> newEvents = new ArrayList<>();
    List<DeadLetterEvent> existingEvents = new ArrayList<>();
    Map<String, DeadLetterQueueEventDTO> eventDtoMap = new HashMap<>();
    ...
    Map<String, DeadLetterEvent> existingEventMap = new HashMap<>();
